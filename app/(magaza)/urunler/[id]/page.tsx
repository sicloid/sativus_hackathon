      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-4 mb-8">
            <div className="flex brutal-border brutal-shadow w-32">
            ...
            <button onClick={handleAddToCart} className="flex-grow bg-[var(--brutal-green)] brutal-border brutal-shadow brutal-shadow-hover font-black uppercase text-xl">
              Sepete Ekle
            </button>
            <button className="bg-white brutal-border brutal-shadow brutal-shadow-hover px-4 flex items-center justify-center hover:bg-[var(--brutal-red)] transition-colors">
      ...
      <div className="mt-12">
        <div className="flex border-b-4 border-black mb-6">
          <button 
            ...
            className={`px-8 py-4 font-black uppercase text-xl transition-colors ${activeTab === 'details' ? 'bg-black text-white' : 'bg-white hover:bg-gray-100'}`}
          >
            Açıklama
          </button>
          <button 
            onClick={() => setActiveTab('reviews')}
            className={`px-8 py-4 font-black uppercase text-xl border-l-4 border-black transition-colors ${activeTab === 'reviews' ? 'bg-black text-white' : 'bg-white hover:bg-gray-100'}`}
          >
            Değerlendirmeler
          </button>
          <button 
            onClick={() => setActiveTab('qa')}
            className={`px-8 py-4 font-black uppercase text-xl border-l-4 border-black transition-colors ${activeTab === 'qa' ? 'bg-black text-white' : 'bg-white hover:bg-gray-100'}`}
          >
            Satıcıya Sor
          </button>
        </div>
