...
const blogPosts = [
  ...
  { id: 6, featured: false, kategori: "Teknoloji", baslik: "PetVerse Akıllı Tasma Rehberi", ozet: "PetVerse AI ile entegre kullanım ipuçları", yazar: "Zeynep Kurt", sure: "4 dk", tarih: "8 Nis 2026", image: "https://picsum.photos/id/0/600/400", icerik: "Yeni nesil teknolojiler sayesinde dostlarımızın adımlarını, sağlık verilerini ve konumlarını anlık olarak izleyebiliyoruz. PetVerse'ün en son piyasaya sürdüğü akıllı tasmalar, kalp ritminden uyku kalitesine kadar pek çok veriyi analiz ederek, olası bir sağlık sorununu henüz belirti vermeden tespit edebiliyor. Uygulamanızla bu cihazları nasıl eşleştirebileceğinizi adım adım anlattık." },
