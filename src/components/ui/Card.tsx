...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-2xl border-4 border-black bg-white text-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]",
        className
      )}
      {...props}
    />
...
const CardFooter = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn("flex items-center p-6 pt-0 border-t-4 border-black mt-6", className)}
      {...props}
    />
  )
)
