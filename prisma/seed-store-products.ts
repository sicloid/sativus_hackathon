...
const storeProducts = [
  ...
  { name: 'Kuş Yemi Otomatik', description: 'Akıllı yemleme haznesi, kabuk biriktirmeyen dökülme önleyici sistem.', price: 340, imageUrl: 'https://images.unsplash.com/photo-1522858547137-f1dcec554f55?w=800&q=80', category: 'Kuş', stockQuantity: 15 },
  ...
  { name: 'Kuş Kafesi Küçük', description: 'Tek kuş için uygun, kolay temizlenebilir alt çekmeceli kafes.', price: 280, imageUrl: 'https://images.unsplash.com/photo-1522858547137-f1dcec554f55?w=800&q=80', category: 'Kuş', stockQuantity: 10 },
  { name: 'Kuş Banyosu Plastik', description: 'Kafes kapısına asılan, şeffaf kapaklı banyo havuzu.', price: 65, imageUrl: 'https://images.unsplash.com/photo-1522858547137-f1dcec554f55?w=800&q=80', category: 'Kuş', stockQuantity: 25 },
  ...
  { name: 'Balık Yemi Granül', description: 'Tüm tropikal balıklar için uygun, renk canlandırıcı kaliteli granül yem.', price: 75, imageUrl: 'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?w=800&q=80', category: 'Balık', stockQuantity: 100 },
  ...
  { name: 'Hava Motoru Sessiz', description: 'Çift çıkışlı, ayarlanabilir hava debili, titreşim önleyici ayaklı motor.', price: 220, imageUrl: 'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?w=800&q=80', category: 'Balık', stockQuantity: 20 },
  { name: 'Akvaryum Termometre', description: 'Hassas ölçüm yapan, vantuzlu, kolay okunabilir derece.', price: 85, imageUrl: 'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?w=800&q=80', category: 'Balık', stockQuantity: 40 },
  { name: 'Su Kondisyoneri 500ml', description: 'Musluk suyundaki kloru anında temizleyen, mukoza koruyucu su düzenleyici.', price: 95, imageUrl: 'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?w=800&q=80', category: 'Balık', stockQuantity: 30 },
  { name: 'Akvaryum Dekor Taş', description: 'Doğal volkanik kayalar, su değerlerini bozmayan dekoratif taş seti.', price: 145, imageUrl: 'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?w=800&q=80', category: 'Balık', stockQuantity: 15 },
  { name: 'Balık Ağı Seti', description: 'Yumuşak fileli, paslanmaz saplı 2\'li balık yakalama ağı.', price: 55, imageUrl: 'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?w=800&q=80', category: 'Balık', stockQuantity: 40 },
  ...
  { name: 'Hamster Koşu Tekeri', description: 'Sessiz rulmanlı, ayak yaralanmalarını önleyen geniş çaplı tekerlek.', price: 120, imageUrl: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=800&q=80', category: 'Kemirgen', stockQuantity: 25 },
  ...
  { name: 'Kemirgen Talaş Altlık', description: 'Yüksek emici güce sahip, tozdan arındırılmış çam talaşı.', price: 75, imageUrl: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=800&q=80', category: 'Kemirgen', stockQuantity: 100 },
  { name: 'Tavşan Kafesi', description: 'Geniş tabanlı, kolay açılır tavanlı, metal gövdeli tavşan evi.', price: 650, imageUrl: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=800&q=80', category: 'Kemirgen', stockQuantity: 5 },
  ...
  { name: 'Guinea Pig Yemi', description: 'C vitamini katkılı, meyve ve sebze kurusu karışımlı özel yem.', price: 85, imageUrl: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=800&q=80', category: 'Kemirgen', stockQuantity: 35 },
  { name: 'Kemirgen Su Şişesi', description: 'Damlatmaz bilyalı uçlu, kafese asılan 500ml suluk.', price: 65, imageUrl: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=800&q=80', category: 'Kemirgen', stockQuantity: 30 },
  { name: 'Hamster Evi Ahşap', description: 'Doğal ağaçtan üretilmiş, çatılı şirin hamster yuvası.', price: 195, imageUrl: 'https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=800&q=80', category: 'Kemirgen', stockQuantity: 15 },
